...
// 问题简化：在一个xy平面内(New York City)选择N个点(pinned Interest)，每个点有各自的数值(interest.time.visit), 然后需要画M个圈(travel days)，
...
//         12:00 - 14:00: lunch
//         14:00 - 17:00: [0012]
//         17:00 - 18:00: free => recommend Interest
//         18:00 - 20:00: dinner
//         20:00 - 22:00: free => recommend Interest
//         22:00 - 07:00: sleep
//         }
//  {day 2:
//         07:00 - 08:00: breakfast
//         08:00 - 11:00: [0003]
//         11:00 - 12:00: free => recommend Interest
//         12:00 - 14:00: lunch
//         14:00 - 16:00: [0006]
//         16:00 - 18:00: free => recommend Interest
//         18:00 - 20:00: dinner
//         20:00 - 22:00: free => recommend Interest
//         22:00 - 07:00: sleep
//         }
...
//         11:00 - 12:00: free => recommend Interest
//         12:00 - 14:00: lunch
//         14:00 - 18:00: free => recommend Interest
//         18:00 - 20:00: dinner
//         20:00 - 22:00: free => recommend Interest
//         22:00 - 07:00: sleep
//         }}
...
// Algorithm:
// Step 1: briefly check if selection is valid: based on travel days and the numbers of Interest, check if it is possible to generate schedule.
//         the number of Interest should be smaller than the maximum possible Interest that can be visited during travel
//         briefly check the number of Interest vs days (approximately 2-3 Interest per day)
// Step 2: calculate distances between each Interest. make sure shortest travel distance between Interest each day
...
// Step 3: put each Interest into different days slots: morning(08-12 4h)/afternoon(14-18 4h)/evening(20-22 2h)
...
public class routeOptimization {
    ...
    public List<List<Interest>> optimizeRoute(List<Interest> pinnedInterests, int days) {
        ...
        // briefly check the total number of Interest / days rate. Approximately 2-3 Interest per day is good
        ...
        if (numberOfInterests / days >= 3) {
            ...
            // two Interest per day. final days may apply three Interest per day
